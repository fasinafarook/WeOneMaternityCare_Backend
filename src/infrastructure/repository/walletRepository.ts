...
class WalletRepository  implements IWalletRepository{
    async createWallet(ownerId: string, ownerType: 'user' | 'serviceProvider'): Promise<Wallet> {
    ...
    async updateWallet(ownerId: string, amount: number, type: "credit" | "debit"): Promise<Wallet> {
